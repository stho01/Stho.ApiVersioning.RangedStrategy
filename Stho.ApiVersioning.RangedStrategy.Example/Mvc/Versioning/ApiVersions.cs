...
namespace CustomAttributeExample.Mvc.Versioning
{
    public class ApiVersions : IEnumerable<ApiVersion>
    {
        ...
        //public bool Contains(ApiVersion item) => _versions.Contains(item);
        //public void CopyTo(ApiVersion[] array, int arrayIndex) => _versions.CopyTo(array, arrayIndex);
        //public bool Remove(ApiVersion item) => _versions.Remove(item);
